...
use Admin\ContentBlockBundle\Admin\Form\EventListener\AddIdFieldSubscriber;
use Admin\ContentBlockBundle\Admin\Form\EventListener\AddContentTypeFieldSubscriber;
...
class ContentBlockType extends AbstractType {
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $optionsNormalizer = function (Options $options, $value) {
            $value = 'Admin\ContentBlockBundle\Entity\ContentBlock';

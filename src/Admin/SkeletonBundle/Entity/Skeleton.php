...
namespace Admin\SkeletonBundle\Entity;
...
/**
 * Admin\SkeletonBundle\Entity\Skeleton
 *
 * @ORM\Table(name="skeletons")
 * @DoctrineAssert\UniqueEntity(fields="alias", message="Alias must be unique")
 * @ORM\Entity(repositoryClass="Admin\SkeletonBundle\Repository\SkeletonRepository")
 */
class Skeleton {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Admin\CategoryBundle\Entity\Category", inversedBy="skeletons", cascade={"persist"})
     * @ORM\JoinTable(name="skeletons_categories")
     */
    protected $categories;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\TagBundle\Entity\Tag", inversedBy="skeletons", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="skeleton_maincontents", cascade={"persist"})
     * @ORM\JoinTable(name="skeleton_maincontent_blocks")
     * */
    protected $maincontentblocks;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="skeleton_bannercontents", cascade={"persist"})
     * @ORM\JoinTable(name="skeleton_bannercontent_blocks")
     * */
    protected $bannercontentblocks;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="skeleton_modalcontents", cascade={"persist"})

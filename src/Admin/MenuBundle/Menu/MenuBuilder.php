...
namespace Admin\MenuBundle\Menu;
...
use Admin\MenuBundle\Entity\Menu as Menu;
...
class MenuBuilder {
    ...
    public function __construct(FactoryInterface $factory, EntityManager $em, ContainerInterface $container) {
        ...
        $this->allowedAccessLevels = $this->container->get('admin_menu.services.helpers')->getAllowedAccessLevels($this->userRole);
    }
    ...
    public function createMenu(Request $request, $menuGroup, $cssClass, $menuItemDecorator) {
        ...
        $voter = $this->container->get('admin_menu.voter.request');
    ...
    public function setupMenuItem($menu, $menuItemList, $menuItemDecorator) {
        ...
        foreach ($menuItemList as $menuItem) {
            ...
            $accessAllowedForUserRole = $this->container->get('admin_menu.services.helpers')->isUserAccessAllowedByRole(

...
class Menu {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Admin\PageBundle\Entity\Page")
     * @ORM\JoinColumn(name="page", referencedColumnName="id", onDelete="SET NULL")
     */
    protected $page;

    /**
     * @ORM\ManyToOne(targetEntity="Admin\BlogBundle\Entity\Blog")
     ...
     * Get page
     *
     * @return \Admin\PageBundle\Entity\Page
     */
     ...
     * Set blog
     *
     * @param \Admin\BlogBundle\Entity\Blog $blog
     * @return Menu
     */

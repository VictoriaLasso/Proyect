...
namespace Admin\PageBundle\Form\Handler;
...
class ContactFormHandler
{
    ...
    public function __construct(FormInterface $form, Request $request, Container $container)
    {
        ...
        $this->settings = $this->container->get('admin_settings.load_settings')->loadSettings();
    }
    ...
    {
        return $this->container->get('admin_page.services.form_mailer')->sendContactFormEmail($emailData);
    }

 ...
 * @ORM\Entity(repositoryClass="Admin\PageBundle\Repository\PageRepository")
 */
class Page {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Admin\CategoryBundle\Entity\Category", inversedBy="pages", cascade={"persist"})
     * @ORM\JoinTable(name="pages_categories")
     */
    protected $categories;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\TagBundle\Entity\Tag", inversedBy="pages", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="maincontents", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinTable(name="maincontent_blocks")
     * */
    protected $maincontentblocks;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="bannercontents", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinTable(name="bannercontent_blocks")
     * */
    protected $bannercontentblocks;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="secondarycontents", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinTable(name="secondarycontent_blocks")
     * */
    protected $secondarycontentblocks;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="extracontents", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinTable(name="extracontent_blocks")
     * */
    protected $extracontentblocks;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\ContentBlockBundle\Entity\ContentBlock", inversedBy="modalcontents", cascade={"all"}, orphanRemoval=true)
     ...
     *
     * @param Admin\ContentBlockBundle\Entity\ContentBlock $secondarycontentblocks
     * @return Page
     */
    public function addSecondarycontentblock(\Admin\ContentBlockBundle\Entity\ContentBlock $secondarycontentblocks) {
     ...
     * @param Admin\ContentBlockBundle\Entity\ContentBlock $secondarycontentblocks
     */
    public function removeSecondarycontentblock(\Admin\ContentBlockBundle\Entity\ContentBlock $secondarycontentblocks) {
     ...
     * @return Page
     */
    public function addCategories(\Admin\CategoryBundle\Entity\Category $categories) {
        $this->categories[] = $categories;
     ...
     * @param Admin\CategoryBundle\Entity\Category $categories
     */
    public function removeCategories(\Admin\CategoryBundle\Entity\Category $categories) {
        $this->categories->removeElement($categories);
    }

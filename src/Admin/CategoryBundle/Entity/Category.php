...
class Category {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Admin\PageBundle\Entity\Page", mappedBy="categories", cascade={"persist"})
     */
    protected $pages;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\BlogBundle\Entity\Blog", mappedBy="categories", cascade={"persist"})
     */
    protected $blogs;

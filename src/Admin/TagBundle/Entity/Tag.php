...
namespace Admin\TagBundle\Entity;
...
class Tag {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Admin\PageBundle\Entity\Page", mappedBy="tags", cascade={"persist"})
     */
    protected $pages;

    /**
     * @ORM\ManyToMany(targetEntity="Admin\BlogBundle\Entity\Blog", mappedBy="tags", cascade={"persist"})
     */
    protected $blogs;
     ...
     * Add pages
     *
     * @param \Admin\PageBundle\Entity\Page $pages
     * @return Tag
     */
    public function addPage(\Admin\PageBundle\Entity\Page $pages) {
        $this->pages[] = $pages;
     ...
     * @param \Admin\PageBundle\Entity\Page $pages
     */
    public function removePage(\Admin\PageBundle\Entity\Page $pages) {

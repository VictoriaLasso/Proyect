...
namespace Admin\CommentBundle\Entity;
...
/**
 * Admin\CommentBundle\Entity\Comment
 *
 * @ORM\Table(name="comments")
 * @ORM\HasLifecycleCallbacks
 * @ORM\Entity(repositoryClass="Admin\CommentBundle\Repository\CommentRepository")
 */
class Comment {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Admin\BlogBundle\Entity\Blog", inversedBy="comments")
     ...
     * Set blogPost
     *
     * @param \Admin\BlogBundle\Entity\Blog $blogPost
     *
     * @return Comment
     */
    public function setBlogPost(\Admin\BlogBundle\Entity\Blog $blogPost = null) {
     ...
     * Get blogPost
     *
     * @return \Admin\BlogBundle\Entity\Blog
     */
